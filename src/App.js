      ...
      <header>
        <nav>
          <ul class="nav-right-section">
            <li><a href="https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/anchor-is-valid.md ">Gmail</a></li>
            <li><a href="">Images</a></li>
            <li class="menu-icon"><a href=""></a></li>
            <li><a href="">
              <img src="https://lh3.googleusercontent.com/ogw/ADGmqu9DkivLOaavTEW54bLZEm6EY2DxaJiUI8Fylfdl=s32-c-mo" />
            </a></li>
          </ul>
        </nav>
      </header>
